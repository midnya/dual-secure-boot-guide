...
> Update 17/05/2026: This guide might be outdated; but if for some reason you're following it: please set a password for your Bitlocker partition (https://github.com/Nightmare-Eclipse/YellowKey).
